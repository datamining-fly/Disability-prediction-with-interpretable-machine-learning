...
1. What the project does:This project utilized random forest and two interpretability methods (1. The built-in variable importance measure of random forest, 2. The SHapley Additive exPlanations [SHAP] method) to construct disability prediction models and identify important predictors of disability.
